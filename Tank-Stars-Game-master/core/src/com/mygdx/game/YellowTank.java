...
public class YellowTank implements Screen {
    final CustomTankStars game;
    private final Rectangle Tank;
    private final Texture yellowTank;
    ...
    final Music music;
    public YellowTank(final CustomTankStars game, final Music music) {
        this.game = game;
        this.music = music;
        rightClick = new Texture(Gdx.files.internal("right_click.png"));
        leftClick = new Texture(Gdx.files.internal("left_click.png"));
        yellowTank = new Texture(Gdx.files.internal("yellow_tank.png"));
    ...
    public void render(float delta) {
        ...
        game.batch.draw(yellowTank, Tank.x, Tank.y, Tank.width, Tank.height);
        game.batch.draw(yellowTank, 575, 230, 150, 150);
