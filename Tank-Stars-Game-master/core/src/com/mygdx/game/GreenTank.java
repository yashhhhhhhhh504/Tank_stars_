...
public class GreenTank implements Screen {
    final CustomTankStars game;
    private final Rectangle Tank;
    private final Texture greenTank;
    ...
    final Music music;
    public GreenTank(final CustomTankStars game, final Music music) {
        this.game = game;
        this.music = music;
        rightClick = new Texture(Gdx.files.internal("right_click.png"));
        leftClick = new Texture(Gdx.files.internal("left_click.png"));
        greenTank = new Texture(Gdx.files.internal("green_tank.png"));
    ...
    public void render(float delta) {
        ...
        game.batch.draw(greenTank, Tank.x, Tank.y, Tank.width, Tank.height);
        game.batch.draw(greenTank, 575, 230, 150, 150);
